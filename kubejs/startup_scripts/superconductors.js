...
GTCEuStartupEvents.registry('gtceu:material', event => {
    ...
    event.create('signalum')
        ...
        .color(0xff3300)
        .iconSet(GTMaterialIconSet.SHINY)
        .blastTemp(1700, $BlastProperty.GasTier.LOW, GTValues.V[GTValues.MV], 1200)
        .flags(GTMaterialFlags.GENERATE_FOIL, GTMaterialFlags.GENERATE_GEAR, GTMaterialFlags.GENERATE_LONG_ROD, GTMaterialFlags.GENERATE_PLATE,
            GTMaterialFlags.GENERATE_ROD, GTMaterialFlags.GENERATE_ROTOR, GTMaterialFlags.GENERATE_SMALL_GEAR, GTMaterialFlags.GENERATE_RING, GTMaterialFlags.GENERATE_FRAME)
    ...
    event.create('lumium')
        ...
        .color(0xffffb3)
        .iconSet(GTMaterialIconSet.SHINY)
        .blastTemp(1700, $BlastProperty.GasTier.LOW, GTValues.V[GTValues.HV], 1500)
        .flags(GTMaterialFlags.GENERATE_FOIL, GTMaterialFlags.GENERATE_GEAR, GTMaterialFlags.GENERATE_LONG_ROD, GTMaterialFlags.GENERATE_PLATE,
            GTMaterialFlags.GENERATE_ROD, GTMaterialFlags.GENERATE_ROTOR, GTMaterialFlags.GENERATE_SMALL_GEAR, GTMaterialFlags.GENERATE_RING, GTMaterialFlags.GENERATE_FRAME)
    ...
    event.create('shellite')
        ...
        .color(0x9933ff)
        .iconSet(GTMaterialIconSet.SHINY)
        .blastTemp(4400, $BlastProperty.GasTier.MID, GTValues.V[GTValues.IV], 1800)
        .flags(GTMaterialFlags.GENERATE_FOIL, GTMaterialFlags.GENERATE_GEAR, GTMaterialFlags.GENERATE_LONG_ROD, GTMaterialFlags.GENERATE_PLATE,
            GTMaterialFlags.GENERATE_ROD, GTMaterialFlags.GENERATE_ROTOR, GTMaterialFlags.GENERATE_SMALL_GEAR, GTMaterialFlags.GENERATE_RING, GTMaterialFlags.GENERATE_FRAME)
    ...
    event.create('twinite')
        ...
        .color(0xf66999)
        .iconSet(GTMaterialIconSet.SHINY)
        .blastTemp(5300, $BlastProperty.GasTier.MID, GTValues.V[GTValues.LuV], 2100)
        .flags(GTMaterialFlags.GENERATE_FOIL, GTMaterialFlags.GENERATE_GEAR, GTMaterialFlags.GENERATE_LONG_ROD, GTMaterialFlags.GENERATE_PLATE,
            GTMaterialFlags.GENERATE_ROD, GTMaterialFlags.GENERATE_ROTOR, GTMaterialFlags.GENERATE_SMALL_GEAR, GTMaterialFlags.GENERATE_RING, GTMaterialFlags.GENERATE_FRAME)
    ...
    event.create('dragonsteel')
        ...
        .color(0x3333cc)
        .iconSet(GTMaterialIconSet.SHINY)
        .blastTemp(7100, $BlastProperty.GasTier.HIGH, GTValues.V[GTValues.ZPM], 2400)
        .flags(GTMaterialFlags.GENERATE_FOIL, GTMaterialFlags.GENERATE_GEAR, GTMaterialFlags.GENERATE_LONG_ROD, GTMaterialFlags.GENERATE_PLATE,
            GTMaterialFlags.GENERATE_ROD, GTMaterialFlags.GENERATE_ROTOR, GTMaterialFlags.GENERATE_SMALL_GEAR, GTMaterialFlags.GENERATE_RING, GTMaterialFlags.GENERATE_FRAME)
    ...
    event.create('prismalium')
        ...
        .color(0x66ffff)
        .iconSet(GTMaterialIconSet.SHINY)
        .blastTemp(9000, $BlastProperty.GasTier.HIGH, GTValues.V[GTValues.ZPM], 2700)
        .flags(GTMaterialFlags.GENERATE_FOIL, GTMaterialFlags.GENERATE_GEAR, GTMaterialFlags.GENERATE_LONG_ROD, GTMaterialFlags.GENERATE_PLATE,
            GTMaterialFlags.GENERATE_ROD, GTMaterialFlags.GENERATE_ROTOR, GTMaterialFlags.GENERATE_SMALL_GEAR, GTMaterialFlags.GENERATE_RING, GTMaterialFlags.GENERATE_FRAME)
    ...
    event.create('melodium')
        ...
        .color(0xd9b3ff)
        .iconSet(GTMaterialIconSet.SHINY)
        .blastTemp(10000, $BlastProperty.GasTier.HIGHER, GTValues.V[GTValues.UV], 3000)
        .flags(GTMaterialFlags.GENERATE_FOIL, GTMaterialFlags.GENERATE_GEAR, GTMaterialFlags.GENERATE_LONG_ROD, GTMaterialFlags.GENERATE_PLATE,
            GTMaterialFlags.GENERATE_ROD, GTMaterialFlags.GENERATE_ROTOR, GTMaterialFlags.GENERATE_SMALL_GEAR, GTMaterialFlags.GENERATE_RING, GTMaterialFlags.GENERATE_FRAME)
    ...
    event.create('stellarium')
        ...
        .color(0xccffff)
        .iconSet(GTMaterialIconSet.SHINY)
        .blastTemp(10799, $BlastProperty.GasTier.HIGHEST, GTValues.V[GTValues.UHV], 6000)
        .flags(GTMaterialFlags.GENERATE_FOIL, GTMaterialFlags.GENERATE_GEAR, GTMaterialFlags.GENERATE_LONG_ROD, GTMaterialFlags.GENERATE_PLATE,
            GTMaterialFlags.GENERATE_ROD, GTMaterialFlags.GENERATE_ROTOR, GTMaterialFlags.GENERATE_SMALL_GEAR, GTMaterialFlags.GENERATE_RING, GTMaterialFlags.GENERATE_FRAME)
