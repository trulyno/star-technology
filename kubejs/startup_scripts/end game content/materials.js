...
function newFunction() {
    ...
    GTCEuStartupEvents.registry('gtceu:material', event => {
        ...
        event.create('prudentium')
            .fluid()
            .element(GTElements.get('prudentium'))
            .color(0x007B1F);

        event.create('tertium')
            .fluid()
            .element(GTElements.get('tertium'))
            .color(0xA63F00);

        event.create('imperium')
            .fluid()
            .element(GTElements.get('imperium'))
            .color(0x0076CA);

        event.create('supremium')
            .fluid()
            .element(GTElements.get('supremium'))
            .color(0xC20000);

        event.create('insanium')
            .fluid()
            .element(GTElements.get('insanium'))
            .color(0x640099);
        ...
        event.create('infertron')
            .gem()
            .color(0x6A730F)
            .iconSet(GTMaterialIconSet.GEM_VERTICAL);

        event.create('prudentron')
            .gem()
            .color(0x156F26)
            .iconSet(GTMaterialIconSet.GEM_VERTICAL);

        event.create('tertron')
            .gem()
            .color(0xB54800)
            .iconSet(GTMaterialIconSet.GEM_VERTICAL);

        event.create('impertron')
            .gem()
            .color(0x1A59D2)
            .iconSet(GTMaterialIconSet.GEM_VERTICAL);

        event.create('supremtron')
            .gem()
            .color(0x9C0000)
            .iconSet(GTMaterialIconSet.GEM_VERTICAL);

        event.create('insanitron')
            .gem()
            .color(0x440065)
            .iconSet(GTMaterialIconSet.GEM_VERTICAL);
