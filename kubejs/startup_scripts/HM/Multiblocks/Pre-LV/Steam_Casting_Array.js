...
GTCEuStartupEvents.registry('gtceu:machine', event => {
	event.create('steam_casting_array', 'primitive')
		...
		.pattern(definition => FactoryBlockPattern.start()
			...
			.where('I', Predicates.blocks('gtceu:industrial_steam_casing')
			.or(Predicates.blocks('gtceu:ulv_fluid_input').setPreviewCount(1).setMaxGlobalLimited(1)))
