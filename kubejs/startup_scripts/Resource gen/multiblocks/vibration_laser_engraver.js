...
GTCEuStartupEvents.registry('gtceu:machine', event => {
    event.create('vibration_laser_engraver', 'multiblock')
        ...
        .pattern(definition => FactoryBlockPattern.start()
            .aisle("A#####BCCCB######", "#####DBCCCBD#####", "####DDBCCCBDD####", "###DDBBCCCBBDD###", "##DDBBBCCCBBBDD##", "#DDBBEBBBBBEBBDD#", "BBBBBBBDDDBBBBBBB", "CCCCCBDDADDBCCCCC", "CCCCCBDAAADBCCCCC", "CCCCCBDDADDBCCCCC", "BBBBBBBDDDBBBBBBB", "#DDBBEBBBBBEBBDD#", "##DDBBBCCCBBBDD##", "###DDBBCCCBBDD###", "####DDBCCCBDD####", "#####DBCCCBD#####", "######BCCCB######") 
            ...
            .where("K", Predicates.blocks("kubejs:laser_casing"))
