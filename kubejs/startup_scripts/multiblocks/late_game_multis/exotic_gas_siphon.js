...
GTCEuStartupEvents.registry('gtceu:machine', event => {
    ...
    event.create('exotic_gas_siphon', 'multiblock')
        ...
        .tooltips("§8-----------------------------------")
        .tooltips("§6Exotic Gas Siphoning:")
        .tooltips("§7Siphons exotic gasses directly from the atmosphere through a complex filtration and refining process, directly condensing traditional collection and distillation methods.")
        .tooltips("")
