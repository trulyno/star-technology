...
GTCEuStartupEvents.registry('gtceu:machine', event => {
    ...
    event.create('folding_akreyrium_stabiliser', 'multiblock')
        ...
        .tooltips("§7A reintegration device designed to recombine Akreyrium. By folding the distinct variants of Akreyrium through a precise stabilization matrix over a crystal, a highly refined and pure version of Akreyrium can be obtained.")
        .tooltips("§8-----------------------------------")
        .tooltips("§6Stabilisation Matrix Lens:")
