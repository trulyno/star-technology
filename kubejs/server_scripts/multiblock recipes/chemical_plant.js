...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembly_line('chemical_plant_controller')
        .itemInputs('gtceu:zpm_machine_hull', '4x gtceu:zpm_electric_motor', 'gtceu:naquadah_alloy_rotor', '2x gtceu:niobium_titanium_large_fluid_pipe', '4x #forge:circuits/zpm')
