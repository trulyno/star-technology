...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.extractor('life_essence_extraction')
        ...
        .chancedOutput('mysticalagriculture:life_essence', 10, 0)
        .duration(400)
        .EUt(400);
    ...
    event.recipes.gtceu.centrifuge('life_essence_centrifuging_0')
        ...
        .chancedOutput('mysticalagriculture:enderman_essence', 500, 500)
    ...
    event.recipes.gtceu.centrifuge('life_essence_centrifuging_1')
        ...
        .chancedOutput('mysticalagriculture:blitz_essence', 500, 500)
