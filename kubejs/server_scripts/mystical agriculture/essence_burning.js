...
ServerEvents.recipes(event => {
    ...
    const stone = ['minecraft:stone', 'minecraft:cobblestone', 'minecraft:diorite', 'minecraft:granite', 'minecraft:andesite', 'minecraft:deepslate', 'minecraft:tuff', 'minecraft:calcite', 'gtceu:red_granite','gtceu:marble'];
