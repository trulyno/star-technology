ServerEvents.recipes(event => {
    ...
    //rfc kits
    event.shaped(Item.of('kubejs:ulv_rfc_kit'), [
        ' G ',
        'SCS',
        ' G '
    ], {
