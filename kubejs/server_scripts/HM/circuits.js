...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.circuit_facility('ulv_electronic_circuit')
    ...
    // Parts
    event.recipes.gtceu.circuit_assembler('redstone_servo')
    ...
    event.recipes.gtceu.circuit_assembler('resistor')
    ...
    event.recipes.gtceu.circuit_assembler('diode')
    ...
    // Boards
    event.recipes.gtceu.assembler('resin_circuit_board')
    ...
    event.recipes.gtceu.assembler('resin_printed_circuit_board')
