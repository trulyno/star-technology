ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembler('start:assembler_wood_casing')
        ...
        event.recipes.gtceu.assembler('start:assembler_meshblock')
            .itemInputs('5x exdeorum:string_mesh', '4x gtceu:treated_wood_rod')
    ...
    kineticsieve("string", "192x exdeorum:dust", ['64x minecraft:redstone', '16x minecraft:ender_pearl', '64x minecraft:glowstone_dust', '16x gtceu:sulfur_dust']);
    kineticsieve("string", "64x exdeorum:crushed_blackstone", ['64x gtceu:crushed_galena_ore', '64x gtceu:crushed_stibnite_ore']);
