ServerEvents.recipes(event => {
	...
	event.recipes.gtceu.wiremill('quartz_fiber_cables')
		.itemInputs('minecraft:quartz', 'gtceu:carbon_fiber_mesh')
		.itemOutputs('3x ae2:quartz_fiber')
		.duration(80)
		.EUt(2048);

	event.recipes.gtceu.wiremill('fluix_glass_cables')
		.itemInputs('ae2:fluix_crystal', 'ae2:quartz_fiber')
	...
	event.shaped(Item.of('ae2:basic_card'), [
		'EB ',
		'CPB',
		'EB ',
	], {
		E: 'gtceu:electrum_ingot',
		B: 'gtceu:black_steel_ingot',
		C: '#gtceu:circuits/ev',
		P: 'ae2:calculation_processor'
	});

	event.shaped(Item.of('ae2:advanced_card'), [
		'DB ',
		'CPB',
		'DB ',
	], {
		D: 'gtceu:diamond_lens',
