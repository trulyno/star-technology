ServerEvents.recipes(event => {
    const toRemoveOutput = [
        ...
        'expatternprovider:circuit_cutter', /megacells:sky_steel.*/, /ae2:.*_crafting_storage/, 'ae2:crafting_accelerator', 'ae2:crafting_monitor'
    ];
    const toRemoveId = [
        ...
        'megacells:mega_crafting_unit', 'ae2:network/parts/cable_anchor', /expatternprovider:cutter.*/
    ];
