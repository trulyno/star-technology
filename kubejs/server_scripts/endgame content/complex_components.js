...
ServerEvents.recipes(event => {
    ...
    const ComponentComposition = [
        ...
        {Tier: 'uev', PrimaryMaterial: 'estalritium', SupportMaterial: 'magmadamantite', TierMaterial: 'mythrylimyn', Tier1Under: 'uhv', Tier2Under: 'uv', Rubber: 'styrene_butadiene_rubber', Plastic: 'polyether_ether_ketone', WireTypeComputational: 'astatine_bismuth_tellurium_cobalt_selenium_over_iron_titanium_oxide', WireTypeMechanical: 'hafnium', CableType: 'astatium_bioselex_carbonite', GlassType: 'fusion_glass', CatalystType: 'gravi_star', PrimaryMagnet: 'zapolgium', SecondaryMagnet: 'pure_netherite', Fluid: 'isovol', VoltageCoil: 'thorium_plut_duranide_241', EUt: GTValues.VHA[GTValues.UEV], Scaler: 2, Coolant: 'liquid_helium'},
