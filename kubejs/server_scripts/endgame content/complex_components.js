...
ServerEvents.recipes(event => {
    ...
    const ComponentComposition = [
        ...
        {Tier: 'uev', PrimaryMaterial: 'estalrtium', SupportMaterial: 'magmadamantite', TierMaterial: 'mythrylimyn', Tier1Under: 'uhv', Tier2Under: 'uv', Rubber: 'styrene_butadiene_rubber', Plastic: 'polyether_ether_ketone', WireTypeComputational: 'iron_selenide_over_strontium_titanium_oxide', WireTypeMechanical: 'zirconium', CableType: 'zirconium_selenide_diiodide', GlassType: 'fusion_glass', CatalystType: 'gravi_star', PrimaryMagnet: 'zapolgium', SecondaryMagnet: 'pure_netherite', Fluid: 'isovol', VoltageCoil: 'thorium_plut_duranide_241', EUt: GTValues.VHA[GTValues.UEV], Scaler: 2},
