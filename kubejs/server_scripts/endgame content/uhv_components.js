...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembly_line('uv_electric_motor')
        .itemInputs('gtceu:magnetic_zapolgium_long_rod', '4x gtceu:zalloy_long_rod', '8x gtceu:zalloy_round', '64x gtceu:zirconium_fine_wire', '64x gtceu:zirconium_fine_wire', '2x gtceu:zirconium_selenide_diiodide_single_cable')
    ...
    event.recipes.gtceu.assembler('uhc_fluid_regulator')
        .itemInputs('gtceu:uhv_electric_pump', '2x #forge:circuits/uhv')
    ...
    event.recipes.gtceu.assembly_line('uhv_electric_piston')
        .itemInputs('gtceu:uhv_electric_motor', '4x gtceu:zalloy_plate', '4x gtceu:zalloy_ring', '16x gtceu:zalloy_round', '4x gtceu:zalloy_rod', 'gtceu:zircalloy_4_gear', '2x gtceu:zircalloy_4_small_gear', '2x gtceu:zirconium_selenide_diiodide_single_cable')
        .inputFluids('gtceu:indium_tin_lead_cadmium_soldering_alloy 576', 'gtceu:lubricant 1000', 'gtceu:naquadria 576')
    ...
    event.recipes.gtceu.assembly_line('uhv_robot_arm')
        .itemInputs('4x gtceu:zalloy_long_rod', 'gtceu:zalloy_gear', '3x gtceu:zalloy_small_gear', '2x gtceu:uv_electric_motor', 'gtceu:uhv_electric_piston', '#forge:circuits/uhv', '2x #forge:circuits/uv', '4x #forge:circuits/zpm', '4x gtceu:zirconium_selenide_diiodide_single_cable')
    ...
    event.recipes.gtceu.assembly_line('uhv_field_generator')
        .itemInputs('gtceu:zalloy_frame', '6x gtceu:zalloy_plate', '2x gtceu:gravi_star', '2x gtceu:uhv_emitter', '2x #forge:circuits/uhv', '#forge:circuits/uhv', '64x gtceu:iron_selenide_over_strontium_titantium_oxide_fine_wire', '64x gtceu:iron_selenide_over_strontium_titantium_oxide_fine_wire', '4x gtceu:zirconium_selenide_diiodide_single_cable')
    ...
    //     .itemInputs('gtceu:zalloy_frame', 'gtceu:uv_electric_motor', '4x gtceu:zalloy_long_rod', '2x gtceu:gravi_star', '2x #forge:circuits/uhv', '64x gtceu:neutronium_foil', '32x gtceu:neutronium_foil', '4x gtceu:zirconium_selenide_diiodide_single_cable')
    ...
    event.recipes.gtceu.assembly_line('uhv_sensor')
        .itemInputs('gtceu:zalloy_frame', 'gtceu:uv_electric_motor', '4x gtceu:zalloy_plate', '2x gtceu:gravi_star', '2x #forge:circuits/uhv', '64x gtceu:neutronium_foil', '32x gtceu:neutronium_foil', '4x gtceu:zirconium_selenide_diiodide_single_cable')
        .inputFluids('gtceu:indium_tin_lead_cadmium_soldering_alloy 1152', 'gtceu:naquadria 576')
